  ...
  return (
    <header className="sticky top-0 z-10 bg-white shadow-sm">
      <div className="px-4 mx-auto sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20 space-x-6">
        <Link to='/'>
          <h1 className='top-6 left-6 text-xl font-extrabold text-black hover:text-gray-700 transition-all'>Blogboard</h1>
        </Link>
