...
const HeaderLoggedOut = () => {
  return (
    <div className="flex items-center justify-between h-[10vh] pr-8">
      <Link
        to="/"
        className="ml-8 text-xl font-extrabold text-black hover:text-gray-700 transition-all"
      >
        Blogboard
      </Link>
      {/* Mobile Menu Button */}
      ...
      {/* Desktop Menu */}
      <div className="hidden ml-auto lg:flex items-center lg:justify-center lg:space-x-10">
        <Link
          to="/something"
